...
public class Reporter : MonoBehaviour
{
	...
	void drawToolBar()
	{
		...
		toolBarRect.height = size.y * 2f + 64;
		...
		GUI.skin = toolbarScrollerSkin;
		Vector2 drag = getDrag();
		if ((drag.x != 0) && (downPos != Vector2.zero) && (downPos.y > Screen.height - size.y * 2f - 64)) {
	...
	void DrawLogs()
	{
		...
		buttomRect.x = 0f;
		buttomRect.y = Screen.height - size.y - 64;
	...
	public void OnGUIDraw()
	{
		...
		screenRect.y = 64;
		screenRect.width = Screen.width;
		screenRect.height = Screen.height - 128;

		getDownPos();


		logsRect.x = 0;
		logsRect.y = size.y * 2f + 64;
		logsRect.width = Screen.width;
		logsRect.height = Screen.height * 0.75f - size.y * 2f - 64;
		...
		stackRect.height = Screen.height * 0.25f - size.y - 64;



		detailRect.x = 0f;
		detailRect.y = Screen.height - size.y * 3 - 64;
